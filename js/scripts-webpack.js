...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(function () {
		(0, _jquery2.default)('#submit').click(function (e) {
			...
			var searchTerm = (0, _jquery2.default)('#search-term').val(),
			    params = {
				q: searchTerm,
				type: 'book',
				info: 1,
			...
			makeAjaxRequest('//www.tastekid.com/api/similar', //TasteKid API is case-sensitive.  .Name, not .name, and so on.
			params, 'jsonp', 'GET', function (result) {
				var results = result.Similar.Results;
				// time to find something new!
				showRecommendations(results);
			});
		});
		(0, _jquery2.default)('#reset').click(function (e) {
			e.preventDefault();
			reset();
		});
	});
	...
	function showRecommendations(results) {
		var itemList = [];
		_jquery2.default.each(results, function (i, item) {
		...
		_jquery2.default.each(itemList, function (i, item) {
			...
			var params = {
			    ...
			    newDiv = (0, _jquery2.default)('#template').clone().removeClass('hidden'),
			...
			makeAjaxRequest('//api.nytimes.com/svc/books/v3/reviews.jsonp', params, 'jsonp', 'GET', function (item) {
			...
			(0, _jquery2.default)('#show-similar').append(newDiv);
		});
		(0, _jquery2.default)('#display').show();
	}
	...
	function reset() {
		(0, _jquery2.default)('#search-term').val('').focus();
		(0, _jquery2.default)('#item-title').text('');
		(0, _jquery2.default)('#item-desc').text('');
		(0, _jquery2.default)('#show-similar').html('');
		(0, _jquery2.default)('#display').hide();
	}
